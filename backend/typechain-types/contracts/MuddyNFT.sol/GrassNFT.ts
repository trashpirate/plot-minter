...
export interface GrassNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
  ...
  encodeFunctionData(functionFragment: "nftRate", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "nftRate", data: BytesLike): Result;
...
export interface GrassNFT extends BaseContract {
  connect(runner?: ContractRunner | null): GrassNFT;
  waitForDeployment(): Promise<this>;

  interface: GrassNFTInterface;
  ...
  nftRate: TypedContractMethod<[], [bigint], "view">;
